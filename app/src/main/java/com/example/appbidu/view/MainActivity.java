...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tvALL:
                selectedButton(tvAll, tvComment, tvMedia);
                mCategory = "All";
                viewmodelRating.updateData(numberStar,mCategory);
                break;
            case R.id.tvComment:
                selectedButton(tvComment, tvAll, tvMedia);
                mCategory = "Comment";
                viewmodelRating.updateData(numberStar,mCategory);
                break;
            case R.id.tvMedia:
                selectedButton(tvMedia, tvComment, tvAll);
                mCategory = "Media";
                viewmodelRating.updateData(numberStar,mCategory);
                break;
            case R.id.boxStar1:
                numberStar = 1;
                selectedButtonStar(ctrboxstar1,ctrboxstar2,ctrboxstar3,ctrboxstar4,ctrboxstar5,tv1,tv2,tv3,tv4,tv5);
                viewmodelRating.updateData(numberStar,mCategory);
                break;
            case R.id.boxStar2:
                numberStar =2;
                selectedButtonStar(ctrboxstar2,ctrboxstar1,ctrboxstar3,ctrboxstar4,ctrboxstar5,tv2,tv1,tv3,tv4,tv5);
                viewmodelRating.updateData(numberStar,mCategory);
                break;
            case R.id.boxStar3:
                numberStar =3;
                selectedButtonStar(ctrboxstar3,ctrboxstar2,ctrboxstar1,ctrboxstar4,ctrboxstar5,tv3,tv2,tv1,tv4,tv5);
                viewmodelRating.updateData(numberStar,mCategory);
                break;
            case R.id.boxStar4:
                numberStar =4;
                selectedButtonStar(ctrboxstar4,ctrboxstar3,ctrboxstar2,ctrboxstar1,ctrboxstar5,tv4,tv3,tv2,tv1,tv5);
                viewmodelRating.updateData(numberStar,mCategory);
                break;
            case R.id.boxStar5:
                numberStar = 5;
                selectedButtonStar(ctrboxstar5,ctrboxstar4,ctrboxstar3,ctrboxstar2,ctrboxstar1,tv5,tv4,tv3,tv2,tv1);
                viewmodelRating.updateData(numberStar,mCategory);
                break;
        }
    }

    private void selectedButton(TextView tvAll, TextView tvComment, TextView tvMedia) {
